...
// Modules represent src/ subdirectories. Customize as the codebase grows.
const MODULE_NAMES = ["lib"];

// Allowed runtime dependency directions (A → B means A may import B at runtime)
const ALLOWED_RUNTIME_DEPS = {
  lib: [],
};

// Allowed type-only dependency directions
